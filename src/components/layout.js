                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                    <div class="text-justify col-span-4">
                        <nav>
                            ...
                            <div class="md:hidden flex justify-between flex-col border border-y-1 my-5 px-3 bg-yellow-600">
                                <button class="outline-none mobile-menu-button px-10 text-white">
                                    <div class="flex flex-row justify-between">
                                        <div class="px-10 text-center ">பக்கங்கள்/Menu</div>
                                        <div>
                                ...
                                <div class="mobile-menu text-white">
                                    <div class="flex flex-col text-center" >
                                        ...
                                        <a href="/" class={isPathMatching("/") ? 'bg-cyan-600' : ''} ><div class="px-5 py-1 border-b">முகப்பு / Home</div></a>
                                        <a href="/videos" class={isPathMatching("/videos") ? 'bg-cyan-600' : ''}><div class="px-5 py-1 border-b">காணொளிகள் / Videos</div></a>
                                        <a href="/works" class={isPathMatching("/works") ? 'bg-cyan-600	' : ''}><div class="px-5 py-1 border-b">திருப்பணி / Renovation </div></a>
                                        <a href="/contact" class={isPathMatching("/contact") ? 'bg-cyan-600' : ''}><div class="px-5 py-1"> தொடர்பு & வழி / Contact</div></a>
                                    </div>
                                </div>
                            </div>
                        </nav>
